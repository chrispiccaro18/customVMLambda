...
exports.handler = (event, context, callback) => {
    ...
    Records.forEach(record => {
        ...
        let transcribeCompleted = (oldRecord.transcribeStatus === "IN_PROGRESS" && newRecord.transcribeStatus === "COMPLETED");
        ...
        } else if (newRecord.transcribeStatus === null || newRecord.transcribeStatus === undefined) {
